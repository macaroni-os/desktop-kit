...
SRC_URI="
amd64? ( https://tdf.mirror.garr.it/libreoffice/testing/25.8.4/rpm/x86_64/LibreOffice_25.8.4.2_Linux_x86-64_rpm.tar.gz -> libreoffice-bin-25.8.4.2_Linux_x86-64_rpm.tar.gz )
arm64? ( https://tdf.mirror.garr.it/libreoffice/testing/25.8.4/rpm/aarch64/LibreOffice_25.8.4.2_Linux_aarch64_rpm.tar.gz -> libreoffice-bin-25.8.4.2_Linux_aarch64_rpm.tar.gz )"
LICENSE="LGPL-3"
SLOT="0"
KEYWORDS="*"
...
"
PDEPEND="=app-office/libreoffice-l10n-25.8.4.2*
