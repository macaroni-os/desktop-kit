...
SRC_URI="
amd64? ( https://github.com/telegramdesktop/tdesktop/releases/download/v7.0.5/tdesktop-7.0.5-full.tar.gz -> telegram-desktop-tdesktop-7.0.5.tar.gz )
amd64? ( https://github.com/telegramdesktop/tdesktop/releases/download/v7.0.5/tsetup.7.0.5.tar.xz -> telegram-desktop-tsetup-7.0.5.tar.xz )"
