...
SRC_URI="
amd64? ( https://github.com/telegramdesktop/tdesktop/releases/download/v6.5.1/tdesktop-6.5.1-full.tar.gz -> telegram-desktop-tdesktop-6.5.1.tar.gz )
amd64? ( https://github.com/telegramdesktop/tdesktop/releases/download/v6.5.1/tsetup.6.5.1.tar.xz -> telegram-desktop-tsetup-6.5.1.tar.xz )"
