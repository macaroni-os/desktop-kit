...
SRC_URI="
amd64? ( https://github.com/telegramdesktop/tdesktop/releases/download/v6.2.4/tdesktop-6.2.4-full.tar.gz -> telegram-desktop-tdesktop-6.2.4.tar.gz )
amd64? ( https://github.com/telegramdesktop/tdesktop/releases/download/v6.2.4/tsetup.6.2.4.tar.xz -> telegram-desktop-tsetup-6.2.4.tar.xz )"
