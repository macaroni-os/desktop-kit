...
SRC_URI="
amd64? ( https://github.com/telegramdesktop/tdesktop/releases/download/v6.4.0/tdesktop-6.4.0-full.tar.gz -> telegram-desktop-tdesktop-6.4.0.tar.gz )
amd64? ( https://github.com/telegramdesktop/tdesktop/releases/download/v6.4.0/tsetup.6.4.0.tar.xz -> telegram-desktop-tsetup-6.4.0.tar.xz )"
