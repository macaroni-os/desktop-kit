...
SRC_URI="
amd64? ( https://github.com/telegramdesktop/tdesktop/releases/download/v7.0.7/tdesktop-7.0.7-full.tar.gz -> telegram-desktop-tdesktop-7.0.7.tar.gz )
amd64? ( https://github.com/telegramdesktop/tdesktop/releases/download/v7.0.7/tsetup.7.0.7.tar.xz -> telegram-desktop-tsetup-7.0.7.tar.xz )"
