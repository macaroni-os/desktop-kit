...
SRC_URI="
amd64? ( https://github.com/telegramdesktop/tdesktop/releases/download/v7.2.5/tdesktop-7.2.5-full.tar.gz -> telegram-desktop-tdesktop-7.2.5.tar.gz )
amd64? ( https://github.com/telegramdesktop/tdesktop/releases/download/v7.2.5/tsetup.7.2.5.tar.xz -> telegram-desktop-tsetup-7.2.5.tar.xz )"
