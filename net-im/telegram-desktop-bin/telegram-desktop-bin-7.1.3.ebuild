...
SRC_URI="
amd64? ( https://github.com/telegramdesktop/tdesktop/releases/download/v7.1.3/tdesktop-7.1.3-full.tar.gz -> telegram-desktop-tdesktop-7.1.3.tar.gz )
amd64? ( https://github.com/telegramdesktop/tdesktop/releases/download/v7.1.3/tsetup.7.1.3.tar.xz -> telegram-desktop-tsetup-7.1.3.tar.xz )"
