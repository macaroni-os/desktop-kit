...
SRC_URI="
amd64? ( https://github.com/telegramdesktop/tdesktop/releases/download/v6.7.5/tdesktop-6.7.5-full.tar.gz -> telegram-desktop-tdesktop-6.7.5.tar.gz )
amd64? ( https://github.com/telegramdesktop/tdesktop/releases/download/v6.7.5/tsetup.6.7.5.tar.xz -> telegram-desktop-tsetup-6.7.5.tar.xz )"
