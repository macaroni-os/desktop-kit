...
SRC_URI="
amd64? ( https://github.com/telegramdesktop/tdesktop/releases/download/v7.1.1/tdesktop-7.1.1-full.tar.gz -> telegram-desktop-tdesktop-7.1.1.tar.gz )
amd64? ( https://github.com/telegramdesktop/tdesktop/releases/download/v7.1.1/tsetup.7.1.1.tar.xz -> telegram-desktop-tsetup-7.1.1.tar.xz )"
