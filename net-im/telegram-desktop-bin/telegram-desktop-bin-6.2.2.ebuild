...
SRC_URI="
amd64? ( https://github.com/telegramdesktop/tdesktop/releases/download/v6.2.2/tdesktop-6.2.2-full.tar.gz -> telegram-desktop-tdesktop-6.2.2.tar.gz )
amd64? ( https://github.com/telegramdesktop/tdesktop/releases/download/v6.2.2/tsetup.6.2.2.tar.xz -> telegram-desktop-tsetup-6.2.2.tar.xz )"
