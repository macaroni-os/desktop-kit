...
SRC_URI="
amd64? ( https://github.com/telegramdesktop/tdesktop/releases/download/v7.0.9/tdesktop-7.0.9-full.tar.gz -> telegram-desktop-tdesktop-7.0.9.tar.gz )
amd64? ( https://github.com/telegramdesktop/tdesktop/releases/download/v7.0.9/tsetup.7.0.9.tar.xz -> telegram-desktop-tsetup-7.0.9.tar.xz )"
