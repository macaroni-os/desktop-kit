...
SRC_URI="
amd64? ( https://github.com/mattermost/desktop/releases/download/v5.13.2/mattermost-desktop-5.13.2-linux-x64.tar.gz -> mattermost-desktop-5.13.2.linux-x64.tar.gz )
arm64? ( https://github.com/mattermost/desktop/releases/download/v5.13.2/mattermost-desktop-5.13.2-linux-arm64.tar.gz -> mattermost-desktop-5.13.2.linux-arm64.tar.gz )"
